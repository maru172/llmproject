...
db_to_sheet = {
    '/home/llmproject/Desktop/Transformer/llmproject2/databases/Politics.db': 'Politics',
    '/home/llmproject/Desktop/Transformer/llmproject2/databases/Us.db': 'Us',
    '/home/llmproject/Desktop/Transformer/llmproject2/databases/World.db': 'World',
}
...
def get_total_articles_from_db(db_file):
    # db_to_sheet 딕셔너리에서 db_file에 맞는 sheet_name 찾기
    sheet_name = db_to_sheet.get(db_file)
...
@app.route('/')
def home():
    db_file = request.args.get('db_file', '/home/llmproject/Desktop/Transformer/llmproject2/databases/Politics.db')  # 기본 DB
...
def article_detail(article_id):
    db_file = request.args.get('db_file')  # 선택한 DB 파일 경로
